...
export const LEARNING_TOPICS: LearningTopic[] = [
  {
    ...
    xp: 50,
    description:
      "Pemahaman dasar struktur logika komputasional, penyusunan flowchart, dan pseudocode algoritma sekuensial.",
    learningOutcomes: [
    ...
    keyConcepts: [
      {
        ...
        explanation:
          "Algoritma adalah urutan langkah logis dan terstruktur yang disusun secara sistematis untuk menyelesaikan suatu permasalahan komputasi dalam jumlah langkah berhingga (finiteness).",
      },
      {
        subtitle: "2. Representasi Pseudocode & Contoh Eksekusi",
        explanation:
          "Pseudocode merupakan jembatan antara bahasa manusia dan kode komputer nyata. Berikut contoh algoritma menghitung luas dan keliling segitiga.",
...
Hasil Luas Segitiga: 40.0 cm²`,
      },
      {
        ...
        explanation:
          "Simbol Oval/Terminator (Start/End), Persegi Panjang (Proses komputasi), Jajar Genjang (Input/Output data), dan Belah Ketupat/Diamond (Keputusan kondisional boolean).",
      },
    ],
    lecturerTips: [
    ...
    quiz: [
      {
        question:
          "Simbol flowchart manakah yang digunakan untuk menyatakan proses pengambilan keputusan logika?",
        options: ["Persegi Panjang", "Belah Ketupat (Diamond)", "Jajar Genjang", "Oval"],
        correctIndex: 1,
        explanation:
          "Tepat! Belah ketupat (Decision/Diamond) digunakan untuk evaluasi kondisi yang menghasilkan cabang True atau False.",
      },
      {
        question:
          "Karakteristik algoritma yang menyatakan bahwa algoritma harus berhenti setelah sejumlah langkah tertentu disebut:",
        options: ["Definiteness", "Finiteness", "Effectiveness", "Generality"],
        correctIndex: 1,
        explanation:
          "Benar! Finiteness (keterbatasan) menjamin algoritma tidak akan berjalan selamanya tanpa akhir.",
      },
    ],
    suggestedQuestions: [
  ...
  },
  {
    ...
    xp: 75,
    description:
      "Mempelajari struktur percabangan logika IF, IF-ELSE berganda, dan Switch-Case untuk pengambilan keputusan program.",
    learningOutcomes: [
    ...
    keyConcepts: [
      {
        ...
        explanation:
          "Struktur kontrol keputusan memungkinkan program memilih blok instruksi mana yang akan dieksekusi berdasarkan evaluasi ekspresi kondisi boolean (True atau False).",
      },
      {
        subtitle: "2. Implementasi Sistem Grade Mahasiswa",
        explanation:
          "Berikut implementasi kondisional untuk menentukan predikat kelulusan berdasarkan nilai angka akhir mata kuliah.",
...
print(f"Predikat Mahasiswa: {predikat}")`,
      ...
      },
      {
        ...
        explanation:
          "AND membutuhkan SEMUA kondisi bernilai True agar blok berjalan. OR hanya membutuhkan MINIMAL SATU kondisi bernilai True.",
      },
    ],
    lecturerTips: [
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          "Tepat! (True and False) menghasilkan False, kemudian False or True menghasilkan True.",
      },
      {
        ...
        correctIndex: 1,
        explanation:
          "Benar! Switch-case sangat optimal dan rapi saat memetakan satu variabel ke opsi-opsi nilai diskrit konstan.",
      },
    ],
    suggestedQuestions: [
  ...
  },
  {
    ...
    xp: 100,
    description:
      "Materi penguatan yang direkomendasikan AI. Menguasai perulangan terhitung (FOR) dan bersyarat (WHILE), serta pencegahan Infinite Loop.",
    learningOutcomes: [
    ...
    keyConcepts: [
      {
        ...
        explanation:
          "FOR Loop dianalogikan seperti berlari 5 putaran mengelilingi lintasan (jumlah langkah sudah pasti diketahui di awal). WHILE Loop seperti berlari hingga merasa lelah (berulang selama kondisi True, berhenti saat False).",
      },
      {
        subtitle: "2. Contoh Kode & Mekanisme Guard Counter",
        explanation:
          "Simak contoh perulangan for dan while yang aman dengan pembaruan counter di setiap iterasi.",
...
Pengulangan ke-3`,
      },
      {
        ...
        explanation:
          "Infinite Loop terjadi jika kondisi terminasi WHILE tidak pernah menjadi False (misalnya lupa menambah counter `i++`). Hal ini dapat membekukan aplikasi dan menghabiskan resource CPU/memori.",
      },
    ],
    lecturerTips: [
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          "Tepat sekali! Jika kondisi bernilai True terus menerus tanpa perubahan, sistem akan terjebak dalam perulangan tanpa akhir.",
      },
      {
        question:
          "Perintah mana yang digunakan untuk melompati sisa iterasi saat ini dan langsung menuju ke iterasi berikutnya?",
        options: ["break", "continue", "return", "exit"],
        correctIndex: 1,
        explanation:
          "Benar! `continue` akan melewati baris di bawahnya dan langsung memulai putaran iterasi selanjutnya.",
      },
    ],
    suggestedQuestions: [
  ...
  },
  {
    ...
    xp: 120,
    description:
      "Menyimpan sekumpulan data dalam memori kontinu, manipulasi indeks array satu dimensi dan matriks dua dimensi.",
    learningOutcomes: [
    ...
    keyConcepts: [
      {
        ...
        explanation:
          "Array adalah struktur data linear yang menyimpan sekumpulan elemen bertipe data serupa pada lokasi memori yang berurutan (kontigu).",
      },
      {
        subtitle: "2. Akses Indeks & Operasi Matriks",
        explanation:
          "Elemen pertama selalu beralamat pada indeks 0. Berikut contoh manipulasi array 1D dan matriks 2D.",
...
Elemen baris 2 kolom 3: 6`,
      },
      {
        ...
        explanation:
          "Akses data pada array melalui indeks memiliki kompleksitas waktu O(1) karena lokasi memorinya dapat langsung dihitung berdasarkan alamat dasar dan ukuran tipe data.",
      },
    ],
    lecturerTips: [
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          "Tepat! Karena dimulai dari index 0, maka elemen ke-10 berada pada index 9 (N - 1).",
      },
    ],
    suggestedQuestions: [
  ...
  },
  {
    ...
    xp: 150,
    description:
      "Membagi kode menjadi modul-modul fungsi independen, pemahaman call stack, dan implementasi fungsi rekursif dengan base case.",
    learningOutcomes: [
    ...
    keyConcepts: [
      {
        ...
        explanation:
          "Fungsi memecah program besar menjadi sub-program yang dapat dipakai ulang (reusable) dan mudah diuji, menerapkan prinsip DRY (Don’t Repeat Yourself).",
      },
      {
        subtitle: "2. Rekursi & Base Case",
        explanation:
          "Fungsi rekursif adalah fungsi yang memanggil dirinya sendiri. Syarat mutlak fungsi rekursif adalah adanya Base Case (kondisi berhenti) agar tidak terjadi Stack Overflow.",
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation:
          "Tepat sekali! Base Case merupakan titik berhenti rekursi untuk mencegah pemanggilan tanpa batas yang dapat merusak memori stack.",
      },
    ],
    suggestedQuestions: [
