        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-purple-400 font-bold tracking-wide uppercase">
                {user.email}
              </p>
            </div>
          </div>
        ...
        <div className="relative glass-card rounded-3xl p-8 mb-10 border-t border-white/20 overflow-hidden group bg-white/5 backdrop-blur-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-400 max-w-3xl text-lg font-light leading-relaxed">
              Akses peta belajar adaptif, tetapkan target belajar pribadi, dan pantau kemajuanmu
              dengan sistem pembelajaran yang disesuaikan oleh AI.
            </p>
          </div>
        </div>
