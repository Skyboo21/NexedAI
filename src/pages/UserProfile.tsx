  ...
  return (
    <div className="bg-[#020617] text-slate-100 min-h-screen flex flex-col items-center justify-center relative overflow-hidden font-['Outfit']">
      ...
      <div className="w-full max-w-2xl p-8 sm:p-12 bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl relative z-10 m-4">
        ...
        <button onClick={handleBack} className="text-slate-400 hover:text-white flex items-center space-x-2 text-sm font-bold mb-8 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div className="bg-black/30 p-5 rounded-2xl border border-white/5">
            <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Status Akun</div>
            <div className="text-emerald-400 font-bold flex items-center">
              <span className="w-2 h-2 rounded-full bg-emerald-500 mr-2 animate-pulse"></span> Terverifikasi
            </div>
          </div>
          <div className="bg-black/30 p-5 rounded-2xl border border-white/5">
            <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Bergabung Sejak</div>
            <div className="text-slate-200 font-bold">14 September 2026</div>
          </div>
        </div>

        <div className="flex justify-end border-t border-white/10 pt-8">
          <button onClick={handleLogout} className="bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 font-bold py-3 px-6 rounded-xl transition-all flex items-center space-x-2">
