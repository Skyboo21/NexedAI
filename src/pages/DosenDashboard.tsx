...
export default function DosenDashboard() {
  ...
  return (
    <div className="bg-[#020617] text-slate-100 min-h-screen flex flex-col relative overflow-x-hidden font-['Outfit']">
      ...
      {/* Header Semantik */}
      <header
        className="bg-slate-900/60 backdrop-blur-xl border-b border-white/10 sticky top-0 z-50 transition-all"
        role="banner"
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav aria-label="Navigasi Dosen" className="flex space-x-3">
            <button
              ...
              className="flex items-center space-x-2 text-sm font-semibold bg-white/5 border border-white/10 text-slate-300 hover:text-white hover:bg-white/10 px-4 py-2 rounded-xl transition-all shadow-sm"
            >
              <span>Profil Saya</span>
            </button>
            <button
              onClick={handleLogout}
              className="flex items-center space-x-2 text-sm font-semibold bg-red-500/10 border border-red-500/20 text-red-400 hover:text-red-300 hover:bg-red-500/20 px-4 py-2 rounded-xl transition-all shadow-sm"
            >
              <span>Keluar</span>
            </button>
          </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-10 w-full relative z-10" role="main">
        ...
        <section aria-labelledby="alert-heading">
          <h2
            id="alert-heading"
            className="text-2xl font-extrabold text-white mb-6 flex items-center space-x-3"
          >
            <span className="text-3xl">⚠️</span>
            <span>Perhatian Khusus</span>
            <span className="bg-red-500/20 text-red-400 border border-red-500/30 text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wider animate-pulse shadow-sm">
              Real-time Alert
            </span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-red-950/40 border border-red-500/30 rounded-2xl">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Gagal menyelesaikan Kuis Logika 3 kali berturut-turut.
              </p>
              <button className="text-sm font-bold text-red-400 hover:text-red-300">
            ...
            <div className="p-6 bg-orange-950/40 border border-orange-500/30 rounded-2xl">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Waktu pengerjaan tugas Array melebihi rata-rata kelas (200%).
              </p>
              <button className="text-sm font-bold text-orange-400 hover:text-orange-300">
                Tinjau Log Belajar &rarr;
              </button>
            </div>
          </div>
